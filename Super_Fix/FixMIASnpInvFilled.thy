...
theory   FixMIASnpInvFilled imports  BasicInvariants "../Super_Sketch/Super_Sketch"  begin
...
have i2x: "CXL_SPG_used T 0" by (insert assms, unfold SWMR_state_machine_def, elim conjE, assumption)
have i3x: "nextSnoopIs SnpInv T 0" by (insert assms, unfold SWMR_state_machine_def, elim conjE, assumption)
...
have i569: "(CSTATE IIA T 0 \<and> HSTATE SharedM T \<longrightarrow> reqs2 T = [] \<or> nextReqIs CleanEvict T 1 \<or> nextReqIs CleanEvictNoData T 1 \<or> nextReqIs RdOwn T 1 \<or> nextReqIs RdOwnNoData T 1) " by (insert assms, unfold SWMR_state_machine_def, elim conjE, assumption)
have i570: "(CSTATE IIA T 1 \<and> HSTATE SharedM T \<longrightarrow> reqs1 T = [] \<or> nextReqIs CleanEvict T 0 \<or> nextReqIs CleanEvictNoData T 0 \<or> nextReqIs RdOwn T 0 \<or> nextReqIs RdOwnNoData T 0) " by (insert assms, unfold SWMR_state_machine_def, elim conjE, assumption)
have i571: "(CSTATE IIA T 0 \<and> HSTATE SharedM T \<longrightarrow> CSTATE Shared T 1 \<or> CSTATE SIA T 1 \<or> CSTATE SMAD T 1 \<or> CSTATE ISAD T 1 \<and> nextGOPending T 1 \<and> nextHTDDataPending T 1 \<or> CSTATE ISA T 1 \<and> nextGOPending T 1 \<or> CSTATE ISD T 1 \<and> nextHTDDataPending T 1 \<or> CSTATE SIAC T 1 \<or> (CSTATE SMA T 1 \<and> nextReqIs RdOwnNoData T 1)) " by (insert assms, unfold SWMR_state_machine_def, elim conjE, assumption)
have i572: "(CSTATE IIA T 1 \<and> HSTATE SharedM T \<longrightarrow> CSTATE Shared T 0 \<or> CSTATE SIA T 0 \<or> CSTATE SMAD T 0 \<or> CSTATE ISAD T 0 \<and> nextGOPending T 0 \<and> nextHTDDataPending T 0 \<or> CSTATE ISA T 0 \<and> nextGOPending T 0 \<or> CSTATE ISD T 0 \<and> nextHTDDataPending T 0 \<or> CSTATE SIAC T 0 \<or> (CSTATE SMA T 0 \<and> nextReqIs RdOwnNoData T 0)) " by (insert assms, unfold SWMR_state_machine_def, elim conjE, assumption)
...
using i61
by auto
have i201: "\<not> nextSnoopPending (T \<lparr>buffer1 := Some m\<rparr> [0 +=snpresp RspIFwdM txid] [0 -=snp ] [ 0 s= IIA] [ Dev1 +=d2hd dthd]) 0" by (metis i61 nextSnoopPending_def snps1_MIASnpInv)
have aux_r147: "nextLoad (T \<lparr>buffer1 := Some m\<rparr> [0 +=snpresp RspIFwdM txid] [0 -=snp ] [ 0 s= IIA] [ Dev1 +=d2hd dthd]) 1 = nextLoad T 1" by simp
have aux153: "HSTATE MAD T" by (metis assms i1x i586)
have aux317: "CSTATE IMAD T 1" by (metis i1x i3x i588)
have auxIIA_not_other_states: "\<not> CSTATE ISAD T 0 \<and> \<not> CSTATE ISA T 0 \<and> \<not> CSTATE Shared T 0 \<and> \<not> nextHTDDataPending T 0" by (smt (verit) i147 i1x i384 i3x i578 i584 i602 i648 nextHTDDataPending_def)
show ?thesis
  unfolding SWMR_state_machine_def
  super_sketch3 (intro conjI) (insert assms) (insert assms, unfold  SWMR_def C_msg_P_same_def C_msg_P_oppo_def H_msg_P_same_def C_H_state_def C_msg_not_def H_msg_P_oppo_def C_msg_P_host_def C_state_not_def H_C_state_msg_same_def H_C_state_msg_oppo_def C_msg_state_def C_not_C_msg_def) (cases "dthdatas1 T") (auto)
