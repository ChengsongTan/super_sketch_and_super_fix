theory Test imports "../examples_deps/BasicInvariants"  begin
...
proof (intro conjI)
 ...
 apply  (insert assms)(**)
    apply (smt (verit) CSTATE_HostSide_rule_1_0 goal266 i1x i2x i3x i761 nextGOPendingIs_general_rule_1_1 reqresps_empty_noGOPendingIs1)
    done
 ...
 apply  (insert assms)(**)
    apply (smt (verit) empty_no_snoop2 i213 i4x i856) done
