theory Testing_600To796 imports  "../Super_Sketch/Super_Sketch"  AllBackgroundInvariants  begin
...
definition first_four_hundred: "first_four_hundred T = (       (HSTATE ID T \<and> nextDTHDataFrom 1 T \<longrightarrow> \<not> nextGOPendingIs GO_WritePull T 0) \<and>
    ...
    (CSTATE SIAC T 0 \<and> HSTATE MD T \<and> nextGOPendingIs GO T 0 \<and> nextGOPendingState Invalid T 0 \<longrightarrow> dthdatas1 T = []) \<and>
    (CSTATE SIAC T 1 \<and> HSTATE MD T \<and> nextGOPendingIs GO T 1 \<and> nextGOPendingState Invalid T 1 \<longrightarrow> dthdatas2 T = []) \<and>
    (CSTATE SIAC T 0 \<and> HSTATE MA T \<and> nextGOPendingIs GO T 0 \<and> nextGOPendingState Invalid T 0 \<longrightarrow> dthdatas1 T = []) \<and>
    (CSTATE SIAC T 1 \<and> HSTATE MA T \<and> nextGOPendingIs GO T 1 \<and> nextGOPendingState Invalid T 1 \<longrightarrow> dthdatas2 T = []) \<and>
    (CSTATE SIAC T 0 \<and> HSTATE MAD T \<and> nextGOPendingIs GO T 0 \<and> nextGOPendingState Invalid T 0 \<longrightarrow> dthdatas1 T = []) \<and>
    (CSTATE SIAC T 1 \<and> HSTATE MAD T \<and> nextGOPendingIs GO T 1 \<and> nextGOPendingState Invalid T 1 \<longrightarrow> dthdatas2 T = []) \<and>
    (HSTATE SharedM T \<and> CSTATE SIAC T 0 \<and> nextGOPendingIs GO T 0 \<and> nextGOPendingState Invalid T 0 \<longrightarrow> \<not> CSTATE IIA T 1) \<and>
    (HSTATE SharedM T \<and> CSTATE SIAC T 1 \<and> nextGOPendingIs GO T 1 \<and> nextGOPendingState Invalid T 1 \<longrightarrow> \<not> CSTATE IIA T 0)    
)  "
