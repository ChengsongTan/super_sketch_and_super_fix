...
definition "HostShared_CleanEvictNoData_NotLast' T i = (if HSTATE SharedM T \<and> nextReqIs CleanEvictNoData T i \<and> \<not>(lastSharer T) \<and>  GTS T ((i + 1) mod 2) \<and> \<not> CSTATE IIA T 1
